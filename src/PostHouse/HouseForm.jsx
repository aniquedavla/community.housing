...
class HouseForm extends React.Component {
  ...
  render() {
    ...
    for (let i = 0; i < this.state.uploadDivsCount; i++) {
      ...
      uploadDivs.push(<img alt="image" width="100" height="100" src={this.state.file[i+3]} />);
    }
      ...
      <div className="HouseFormStyle ">
        <Form>
          ...
          <FormGroup>
            ...
            <img alt="image1" width="100" height="100" src={this.state.file[0]} />

            <Input type="file" id="houseImage2" onChange={this.handleChange(1)} />
            <img alt="image2" width="100" height="100" src={this.state.file[1]} />

            <Input type="file" id="houseImage3" onChange={this.handleChange(2)} />
            <img alt="image3" width="100" height="100" src={this.state.file[2]} />
          ...
          <Button onClick={this.storeHouseImages} color="success">Post it !</Button>{' '}
